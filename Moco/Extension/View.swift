...
extension View {
    func forceRotation(_ orientation: UIInterfaceOrientationMask? = nil, resetOrientation: Bool? = true) -> some View {
        modifier(ForceRotationViewModifier(orientation: orientation, resetOrientation: resetOrientation ?? true))
    }
}
